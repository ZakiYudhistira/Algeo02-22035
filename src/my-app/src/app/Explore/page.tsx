...
const Explore = () => {
    return (
        ...
        <div className="box-content w-[42.5rem]">
            ...
            tentang bagaimana cara mendapatkan seorang kekasih di ITB, terutama di tengah
            gempuran tubes dan ketidakpastian dari kondisi pasar kencan. Cara mudahnya adalah, Anda harus
            menjadi good looking dan berduit banyak, tetapi saya yakin, banyak wanita/pria berkualitas baik
            yang lebih mengutamakan atitud ketimbang material lainnya.
            </p>
        </div>
